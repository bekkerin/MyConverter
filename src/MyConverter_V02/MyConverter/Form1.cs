...
namespace MyConverter
{
    public partial class Form1 : Form
    {
        ...
        private void txtDecimal_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if(e.KeyChar == '.')
            {
                txtDecimal.Text = "decimal can not have fraction";
                e.Handled = true;
            } // no commas in number
            else if (e.KeyChar == ',')
            {
                txtDecimal.Text = "do not use thousands separators";
                e.Handled = true;
            }
            // any character other than 0-9
            else if(e.KeyChar < '0' || e.KeyChar > '9')
            {
                txtDecimal.Text = "invalid decimal digit";
                e.Handled = true;
            }
        }
        ...
        private void txtBinary_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                txtBinary.Text = "invalid binary digit";
                e.Handled = true;
            }
        }
        ...
        private void txtOctal_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                txtOctal.Text = "invalid octal digit";
                e.Handled = true;
            }
        }
        ...
        private void txtOctal_Enter(object sender, EventArgs e)
        {
            txtOctal.Text = string.Empty;
        }
